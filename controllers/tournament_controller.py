...
class TournamentController:
    ...
    def create_tournament(cls, db,tdb):
        ...
        indices = []
        choice_ = int(input('entrer the choice'))
        if choice_ == 1:
            for i in range(int(input_nb_player)):
                indices.append(input(f'please enter the indice of {i+1} player  :'))
